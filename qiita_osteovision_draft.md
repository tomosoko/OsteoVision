...
| テスト数 | **580 tests passed / 0 skipped** |
...
- [x] **Formula A 本番適用**: `inference.py` + `validate_real_ct.py` の両方を arctan-shift へ移行済み（580 tests passed）
