...
| テスト数 | **357 tests passed / 0 skipped** |
...
**APIテスト（dicom-viewer-prototype-api/tests/ — 200件）**
...
- [x] **Formula A 本番適用**: `inference.py` + `validate_real_ct.py` の両方を arctan-shift へ移行済み（357 tests passed）
